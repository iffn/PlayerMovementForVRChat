namespace Hirabiki.Udon.Works
{
    ...
    /// Based on SwimLocomotion by Hirabiki: https://booth.pm/ja/items/2127684
    /// </summary>
    //[RequireComponent(typeof(NUMovementLinker))]
    public class NUSwimLocomotion : UdonSharpBehaviour
    {
        [SerializeField] NUMovementSyncMod linkedNUMovement;
...
This mode is for the most dedicated players with full-body setup")]
        ...
        void Start()
        {
            //linkedNUMovement = (NUMovementSyncMod)transform.GetComponent<NUMovementLinker>().LinkedNUMovmement; //To be replced with static access when available in U#
